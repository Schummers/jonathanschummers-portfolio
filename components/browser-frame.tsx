...
export function BrowserFrame({ url, children, className }: BrowserFrameProps) {
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 bg-surface border-b border-border px-xs h-5">
        {/* Traffic light dots */}
        ...
        {/* URL */}
        <span className="text-caption text-text-secondary truncate leading-none">
          {url}
        </span>
      </div>
