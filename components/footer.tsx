...
export function Footer() {
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-blueprint flex-col items-center gap-md border-x border-border px-xl py-xl max-md:px-md md:flex-row md:justify-between md:max-lg:px-lg">
