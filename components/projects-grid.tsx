 ...
 * couleur `border`, le bloc texte est sur `surface`.
 */
export function ProjectsGrid() {
  ...
  return (
    <Section id="projects" className="!p-0 bg-surface">
      <h2 className="bg-border px-container pt-section pb-md font-body text-label font-bold uppercase tracking-label text-text-secondary">
        Personal projects
      </h2>
      <div className="grid max-md:grid-cols-1 max-md:divide-y md:grid-cols-3 md:divide-x divide-border-strong">
